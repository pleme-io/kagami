  ...
  internal = rec {
    ...
    crates = {
      ...
      "kagami-cli" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagami-cli; };
        dependencies = [
          {
            name = "clap";
            packageId = "clap";
      ...
      "kagami-core" = rec {
        crateName = "kagami-core";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagami-core; };
        libName = "kagami_core";
        dependencies = [
          {
            name = "async-trait";
      ...
      "kagami-crawler" = rec {
        crateName = "kagami-crawler";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagami-crawler; };
        libName = "kagami_crawler";
        dependencies = [
          {
            name = "async-trait";
            packageId = "async-trait";
      ...
      "kagami-intel" = rec {
        crateName = "kagami-intel";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagami-intel; };
        libName = "kagami_intel";
        dependencies = [
          {
            name = "async-trait";
            packageId = "async-trait";
        ...
        features = {
          "persistence" = [ "dep:sea-orm" ];
        };
        resolvedDefaultFeatures = [ "persistence" ];
      };
      "kakuremino" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "rustls-tls" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" "socks" ];
      };
      "retry-error" = rec {
      ...
      "scraper" = rec {
        ...
        edition = "2021";
        crateBin = [];
        sha256 = "05ac371c3g40vh82g6a72g6ahymmx8s9f53cvq4y6h2gi0dhagfc";
        authors = [
          "June McEnroe <june@causal.agency>"
        ];
        dependencies = [
